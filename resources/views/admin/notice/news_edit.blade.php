						 ...
						 <form class="layui-form layui-form-pane" id="rpwdform" action="#" >
							<div class="layui-form-item">
                                ...
                                <input type="hidden"  name="id" value="{{$news->id}}"/>
									<input value="{{$news->title}}" type="text" name="title" placeholder="请输入标题" lay-verify="title" autocomplete="off" class="layui-input">
								</div>
							</div>
							<div class="layui-form-item layui-form-text">
								...
								<div class="layui-input-block">
									...
									<textarea placeholder="请输入内容" name="content"  lay-verify="content" class="layui-textarea" id="demo" style="display: none;">{{$news->content}}</textarea>
								</div>
							</div>
							<div class="layui-form-item">
