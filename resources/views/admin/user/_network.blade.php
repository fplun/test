                                                ...
                                                <tr>
                                                  <td>
                                                    ...
                                                    <table border="0" width="200" align="center" bordercolor="#cae2f7" bgcolor="#ffffff" class="Table1">
                                                      <span class="tip">01</span>
                                                      <tbody>
                                                        <tr align="middle">
                                                          <td colspan="3" valign="middle">
                                                            <span style="font-weight: bold; color: white;">
                                                              <a href="/admin/contact_list" class="yeah-tab-a" level="1" offset="left">
                                                            ...
                                                            <table border="0" width="200" align="center" bordercolor="#cae2f7" bgcolor="#ffffff" class="Table1">
                                                              ...
                                                              <tbody>
                                                                ...
                                                                <tr align="middle">
                                                                  <td colspan="3" valign="middle">
                                                                    <span style="font-weight: bold; color: white;">
                                                                      <a href="/admin/contact_list?username={{ $list[1][0]->user->username }}" class="yeah-tab-a" level="2" offset="left">
                                                                ...
                                                                <tr align="middle">
                                                                    ...
                                                                    <a href="/admin/register?position=1&top_uid={{ $list[0]->username }}">注册</a></td>
                                                                </tr>
                                                                @endif
                                                              </tbody>
                                                            </table>
                                                          ...
                                                          <tr>
                                                              <td>
                                                                ...
                                                                <tr align="middle">
                                                                  <td colspan="3" valign="middle">
                                                                    <span style="font-weight: bold; color: white;">
                                                                      <a href="/admin/contact_list?username={{ $list[1][1]->user->username }}" class="yeah-tab-a" level="2" offset="left">
                                                                ...
                                                                <tr align="middle">
                                                                    <td colspan="3" align="center" valign="center">
                                                                    <a href="/admin/register?position=2&top_uid={{ $list[0]->username }}">注册</a></td>
                                                                </tr>
                                                                @endif
                                                              </tbody>
                                                            </table>
                                                                    ...
                                                                    <table border="0" width="200" align="center" bordercolor="#cae2f7" bgcolor="#ffffff" class="Table1">
                                                                      <tbody>
                                                                        @if(isset($list[2][0]))
                                                                            ...
                                                                            <td colspan="3" valign="middle">
                                                                                <span style="font-weight: bold; color: white;">
                                                                                <a href="/admin/contact_list?username={{ $list[2][0]->user->username }}" class="yeah-tab-a" level="2" offset="left">
                                                                            ...
                                                                            <tr align="middle">
                                                                                <td colspan="3" align="center" valign="center">
                                                                                <a href="/admin/register?position=1&top_uid={{ $list[1][0]->user->username }}">注册</a></td>
                                                                            </tr>
                                                                            @endif
                                                                      </tbody>
                                                                    </table>
                                                                            ...
                                                                            <table class="Table1" bordercolor="#cae2f7" cellspacing="1" cellpadding="1" width="200" align="center" bgcolor="#ffffff" border="0">
                                                                              <tbody>
                                                                                @if(isset($list[3][0]))
                                                                                    ...
                                                                                    <td colspan="3" valign="middle">
                                                                                        <span style="font-weight: bold; color: white;">
                                                                                        <a href="/admin/contact_list?username={{ $list[3][0]->user->username }}" class="yeah-tab-a" level="2" offset="left">
                                                                                    ...
                                                                                    <tr align="middle">
                                                                                        <td colspan="3" align="center" valign="center">
                                                                                        <a href="/admin/register?position=1&top_uid={{ $list[2][0]->user->username }}">注册</a></td>
                                                                                    </tr>
                                                                                    @endif
                                                                              </tbody>
                                                                            </table>
                                                                            ...
                                                                            <table class="Table1" bordercolor="#cae2f7" cellspacing="1" cellpadding="1" width="200" align="center" bgcolor="#ffffff" border="0">
                                                                              <tbody>
                                                                                @if(isset($list[3][1]))
                                                                                    ...
                                                                                    <td colspan="3" valign="middle">
                                                                                        <span style="font-weight: bold; color: white;">
                                                                                        <a href="/admin/contact_list?username={{ $list[3][1]->username }}" class="yeah-tab-a" level="2" offset="left">
                                                                                    ...
                                                                                    <tr align="middle">
                                                                                        <td colspan="3" align="center" valign="center">
                                                                                        <a href="/admin/register?position=2&top_uid={{ $list[2][0]->user->username }}">注册</a></td>
                                                                                    </tr>
                                                                                    @endif
                                                                              </tbody>
                                                                            </table>
                                                                    ...
                                                                    <table border="0" width="200" align="center" bordercolor="#cae2f7" bgcolor="#ffffff" class="Table1">
                                                                      <tbody>
                                                                        ...
                                                                        <tr align="middle">
                                                                          <td colspan="3" valign="middle">
                                                                            <span style="font-weight: bold; color: white;">
                                                                              <a href="/admin/contact_list?username={{ $list[2][1]->user->username }}" class="yeah-tab-a" level="3" offset="left">
                                                                        ...
                                                                        <tr align="middle">
                                                                            <td colspan="3" align="center" valign="center">
                                                                            <a href="/admin/register?position=2&top_uid={{ $list[1][0]->user->username }}">注册</a></td>
                                                                        </tr>
                                                                        @endif
                                                                      </tbody>
                                                                    </table>
                                                                            ...
                                                                            <table class="Table1" bordercolor="#cae2f7" cellspacing="1" cellpadding="1" width="200" align="center" bgcolor="#ffffff" border="0">
                                                                              <tbody>
                                                                                @isset($list[3][2])
                                                                                    ...
                                                                                    <td colspan="3" valign="middle">
                                                                                        <span style="font-weight: bold; color: white;">
                                                                                        <a href="/admin/contact_list?username={{ $list[3][2]->user->username }}" class="yeah-tab-a" level="3" offset="left">
                                                                                    ...
                                                                                    <tr align="middle">
                                                                                        <td colspan="3" align="center" valign="center">
                                                                                        <a href="/admin/register?position=1&top_uid={{ $list[2][1]->user->username }}">注册</a></td>
                                                                                    </tr>
                                                                                    @endif
                                                                              </tbody>
                                                                            </table>
                                                                            ...
                                                                            <table class="Table1" bordercolor="#cae2f7" cellspacing="1" cellpadding="1" width="200" align="center" bgcolor="#ffffff" border="0">
                                                                              <tbody>
                                                                                @isset($list[3][3])
                                                                                    ...
                                                                                    <td colspan="3" valign="middle">
                                                                                        <span style="font-weight: bold; color: white;">
                                                                                        <a href="/admin/contact_list?username={{ $list[3][3]->user->username }}" class="yeah-tab-a" level="3" offset="left">
                                                                    ...
                                                                    <table border="0" width="200" align="center" bordercolor="#cae2f7" bgcolor="#ffffff" class="Table1">
                                                                      <tbody>
                                                                        ...
                                                                        <tr align="middle">
                                                                          <td colspan="3" valign="middle">
                                                                            <span style="font-weight: bold; color: white;">
                                                                              <a href="/admin/contact_list?username={{ $list[2][2]->user->username }}" class="yeah-tab-a" level="3" offset="left">
                                                                        ...
                                                                        <tr align="middle">
                                                                            <td colspan="3" align="center" valign="center">
                                                                            <a href="/admin/register?position=1&top_uid={{ $list[1][1]->user->username }}">注册</a></td>
                                                                        </tr>
                                                                        @endif
                                                                      </tbody>
                                                                    </table>
                                                                            ...
                                                                            <table class="Table1" bordercolor="#cae2f7" cellspacing="1" cellpadding="1" width="200" align="center" bgcolor="#ffffff" border="0">
                                                                              <tbody>
                                                                                @isset($list[3][4])
                                                                                    ...
                                                                                    <td colspan="3" valign="middle">
                                                                                        <span style="font-weight: bold; color: white;">
                                                                                        <a href="/admin/contact_list?username={{ $list[3][4]->user->username }}" class="yeah-tab-a" level="3" offset="left">
                                                                                    ...
                                                                                    <tr align="middle">
                                                                                        <td colspan="3" align="center" valign="center">
                                                                                        <a href="/admin/register?position=1&top_uid={{ $list[2][2]->user->username }}">注册</a></td>
                                                                                    </tr>
                                                                                    @endif
                                                                              </tbody>
                                                                            </table>
                                                                            ...
                                                                            <table class="Table1" bordercolor="#cae2f7" cellspacing="1" cellpadding="1" width="200" align="center" bgcolor="#ffffff" border="0">
                                                                              <tbody>
                                                                                @isset($list[3][5])
                                                                                    ...
                                                                                    <td colspan="3" valign="middle">
                                                                                        <span style="font-weight: bold; color: white;">
                                                                                        <a href="/admin/contact_list?username={{ $list[3][5]->user->username }}" class="yeah-tab-a" level="3" offset="left">
                                                                    ...
                                                                    <table border="0" width="200" align="center" bordercolor="#cae2f7" bgcolor="#ffffff" class="Table1">
                                                                      <tbody>
                                                                        ...
                                                                        <tr align="middle">
                                                                          <td colspan="3" valign="middle">
                                                                            <span style="font-weight: bold; color: white;">
                                                                              <a href="/admin/contact_list?username={{ $list[2][3]->user->username }}" class="yeah-tab-a" level="3" offset="left">
                                                                        ...
                                                                        <tr align="middle">
                                                                            <td colspan="3" align="center" valign="center">
                                                                            <a href="/admin/register?position=2&top_uid={{ $list[1][1]->user->username }}">注册</a></td>
                                                                        </tr>
                                                                        @endif
                                                                      </tbody>
                                                                    </table>
                                                                            ...
                                                                            <table class="Table1" bordercolor="#cae2f7" cellspacing="1" cellpadding="1" width="200" align="center" bgcolor="#ffffff" border="0">
                                                                              <tbody>
                                                                                @isset($list[3][6])
                                                                                    ...
                                                                                    <td colspan="3" valign="middle">
                                                                                        <span style="font-weight: bold; color: white;">
                                                                                        <a href="/admin/contact_list?username={{ $list[3][6]->user->username }}" class="yeah-tab-a" level="3" offset="left">
                                                                                    ...
                                                                                    <tr align="middle">
                                                                                        <td colspan="3" align="center" valign="center">
                                                                                        <a href="/admin/register?position=1&top_uid={{ $list[2][3]->user->username }}">注册</a></td>
                                                                                    </tr>
                                                                                    @endif
                                                                              </tbody>
                                                                            </table>
                                                                            ...
                                                                            <table class="Table1" bordercolor="#cae2f7" cellspacing="1" cellpadding="1" width="200" align="center" bgcolor="#ffffff" border="0">
                                                                              <tbody>
                                                                                @isset($list[3][7])
                                                                                    ...
                                                                                    <td colspan="3" valign="middle">
                                                                                        <span style="font-weight: bold; color: white;">
                                                                                        <a href="/admin/contact_list?username=" class="yeah-tab-a" level="3" offset="left">
